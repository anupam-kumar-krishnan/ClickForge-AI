...
const PreviewPanel = ({
  ...
  return (
    <div className="relative mx-auto w-full max-w-2x;">
      <div className={`relative overflow-hidden ${aspectClasses[aspectRatio]}`}>
        ...
        {/* Empty State */}
        {!isLoading && !thumbnail?.image_url && (
          <div className="absolute inset-0 m-2 flex flex-col items-center justify-center ga-4 rounded-lg border-2 border-dashed border-white/20 bg-black/25">
            ...
            <div className="px-4 py-4 text-center">
              ...
              <p className="mt-1 text-xs text-zinc-400">
                Fill out the Details on left and Click Generate
              </p>
            </div>
          </div>
        )}
