...
export default function FeaturesSection() {
  return (
    <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
      <SectionTitle
        text1="Features"
        text2="Built to Boost Your Clicks"
        text3="Create high-impact thumbnails in minutes, no design skills required."
      />
      <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
        {featuresData.map((feature: IFeature, index: number) => (
          <motion.div
            ...
            className={`${
              index === 1
                ? "p-px rounded-[13px] bg-linear-to-br from-indigo-600 to-slate-800"
                : ""
            }`}
      ...
      <div className="mt-40 relative mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
          ...
          >
            <img
              className="h-full w-auto border-indigo-500 border-2 rounded-3xl"
              src="/assets/feature-showcase-1.jpg"
          ...
          >
            <img
              src="/assets/feature-showcase-2.jpg"
              alt="features showcase"
              width={1000}
              height={500}
              className="hover:-translate-y-0.5 transition duration-300 border-indigo-500 border-2 rounded-3xl"
            />
            ...
            <a
              ...
              className="group flex items-center gap-2 mt-4 text-indigo-500 hover:textindigo-600 transition font-medium"
            >
              Start Genrating Free
