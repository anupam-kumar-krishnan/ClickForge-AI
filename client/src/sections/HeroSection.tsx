...
export default function HeroSection() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <motion.a
        href="#"
        className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-pink-100 bg-indigo-200/15"
      ...
      >
        Why spend hours designing? Get high-converting thumbnails in seconds
      ...
      >
        ...
        <button className="flex items-center gap-2 border-2 border-indigo-500 hover:bg-indigo-950/50 transition rounded-full px-6 h-11">
      ...
      <div className="flex flex-wrap justify-center items-center gap-4 md:gap-14 mt-12">
        {specialFeatures.map((feature, index) => (
          ...
          >
            <CheckIcon className="size-5 text-indigo-500" />
