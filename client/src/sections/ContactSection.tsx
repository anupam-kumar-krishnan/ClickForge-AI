      ...
      >
        ...
        >
          ...
          <textarea
            ...
            className="focus:border-indigo-500 resize-none w-full p-3 outline-none rounded-lg border border-slate-700"
          />
        </motion.div>

        <motion.button
          type="submit"
          className="w-max flex items-center gap-2 bg-indigo-500 hover:bg-indigo-700 text-white px-10 py-3 rounded-full"
          initial={{ y: 150, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          viewport={{ once: true }}
          transition={{ type: "spring", stiffness: 280, damping: 70, mass: 1 }}
