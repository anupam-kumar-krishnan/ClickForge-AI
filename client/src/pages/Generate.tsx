              ...
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      maxLength={100}
                      placeholder="e.g. Top Tech Skills in 2026"
                      className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 mt-2"
                    />
                ...
                {!id && (
                  <button
                    ...
                    className="text-[15px] w-full py-3.5 rounded-xl font-medium bg-linear-to-b from-indigo-500 to-indigo-600 hover:from-indigo-700 disabled:cursor-not-allowed transition-colors"
                  >
