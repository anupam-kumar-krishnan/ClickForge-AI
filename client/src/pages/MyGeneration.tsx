      ...
      <div className="mt-32 min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
        ...
        {!loading && thumbnails.length === 0 && (
          <div className="text-center py-24">
            <h3 className="text-lg font-semibold text-white">No Thumbnails</h3>
            ...
            {thumbnails.map((thumb: IThumbnail) => {
              ...
              return (
                <div
                  ...
                  className="mb-8 group relative cursor-pointer rounded-2xl bg-white/6 border border-white/6 transition shadow-xl break-inside-avoid"
                >
                  {/* IMAGE */}
                  <div
